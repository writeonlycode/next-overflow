...
import { fetchServerSideQuestionsWithMetadataSearch, useQuestionsWithMetadataSearch } from "@/lib/questions/questions";
...
export default function SearchPage({ questionsSearchFallback }: any) {
  ...
  const { data, error } = useQuestionsWithMetadataSearch(query.query as string, questionsSearchFallback);
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  ...
  const questionsSearchFallback = await fetchServerSideQuestionsWithMetadataSearch(
    context,
